                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted">
                                    ...
                                    <!-- <th class="min-w-150px">Status Order</th> -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">${{number_format($order -> order_total, 0)}}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <!-- <td>
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">
                                                    @if (($order -> payment_status) == 0) Chờ xử lý
                                                    @elseif (($order -> payment_status) == 1) Đang giao
                                                    @elseif (($order -> payment_status) == 2) Đã nhận hàng
                                                    @elseif (($order -> payment_status) == 3) Đã thanh toán
                                                    @endif
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start flex-shrink-0">
                                            <a href="{{URL::to('/view-order',[$order->order_id])}}" id="update-btn" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <a href="{{URL::to('/delete-product',[$order->order_id])}}" onclick="return confirm('Are you sure delete this product?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
